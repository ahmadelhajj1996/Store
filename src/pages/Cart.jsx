  ...
  const handleConfirm = async () => {
    try {
      ...
      const invalidItem = cart.find(
        (item) => !item.variation_id || !item.product_id
      );
        ...
        <div className="flex flex-col gap-y-6">
              ...
              return (
                <div key={index} className="border-b p-4 last:border-b-0">
                  <div className="flex gap-4">
                    <div className="h-24 w-20 cursor-pointer overflow-hidden rounded-lg bg-gray-100 sm:h-28 sm:w-28">
                      {loading ? (
                        <TopLoader
                          num={1}
                          cols={1}
                    ...
                    <div className="flex flex-1 flex-col justify-between">
                      ...
                      <div className="mt-4 flex items-center justify-between">
                        <div className="bordered grid grid-cols-3 place-items-center gap-x-2 rounded-lg border px-1">
                          <button
                            onClick={() => handleDecrease(item)}
                            className="flex h-8 w-8 items-center justify-center text-cyan-600"
                          >
                            <Minus size={18} />
                          </button>
          ...
          <div className="rounded-xl bg-white p-5 shadow-sm">
            ...
            <button
              ...
              disabled={loading}
              className="button mt-6 flex w-full items-center justify-center gap-2 py-3 text-lg disabled:cursor-not-allowed disabled:opacity-50"
            >
              {loading ? (
                <>
                    ...
                    <div className="flex flex-1 flex-col justify-between">
                      <div className="space-y-2">
                        <div className="flex items-center name text-xs   justify-between gap-3">
                          ...
                          <span className=" -mt-2">
                            {Number(item?.quantity * item?.variation?.price) ||
                              0}{" "}
                            ل.س
                          </span>
                        </div>
