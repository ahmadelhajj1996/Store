...
function Product() {
  ...
  if (!activeVariation?.id) {
    notify("Please select a valid variation", "error");
    return;
  }
  ...
  dispatch(
    addToCart({
      ...
      unit_price: activeVariation.price,

      subtotal: activeVariation.price,

      image: activeVariation.images?.[0],

      selectedAttributes,
    }),
  );
}, [dispatch, product, activeVariation, selectedAttributes]);
