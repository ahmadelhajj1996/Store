...
function Category() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter(
      (p) => String(p.category?.parent_id) === String(id),
    );
  ...
  const normalizedProducts = useMemo(() => {
    ...
    return filteredProducts.map((product) => {
      ...
      return {
        ...
        oldPrice: firstVariation?.price
          ? Number(firstVariation.price) + 20
          : 0,
  ...
  return (
      ...
      <Grid
        ...
        itemClassName="border border-cyan-500"
      ...
      <div className=" mx-2 sm:mx-8 grid min-[350px]:grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
