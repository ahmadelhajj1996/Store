    ...
    <>
      ...
      <div className="min-h-screen    flex flex-col mt-8 ">
        <div className="relative py-3 sm:max-w-xl sm:mx-auto">
          ...
          <div className="relative px-4 py-4 bg-white shadow-lg  sm:p-20 ">
            <div className="max-w-lg mx-auto">
              <div>
                <h1 className="text-xl   text-center">تسجيل الدخول</h1>
              </div>
              <div className="divide-y divide-gray-200" >
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  <div className="relative">
                    ...
                    <label
                      for="email"
                      className="absolute start-0 text-sm -top-3.5 text-gray-600   peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 peer-focus:text-sm"
                    >
                      رقم الهاتف
                    </label>
                  </div>
