...
const Footer = () => {
  ...
  return (
    <div className="relative mt-16 bg-deep-cyan-accent-500">
      ...
      <div className="flex justify-center items-center pt-12 gap-x-12">
        ...
        >
          <svg viewBox="0 0 30 30" fill={"#06B6D4"} className="h-6">
            {" "}
            {/* Changed fill from black to cyan-500 */}
        ...
        <a
          ...
          className="transition-colors duration-300 text-deep-cyan-100 hover:text-cyan-500"
        >
          <svg viewBox="0 0 24 24" fill={"#06B6D4"} className="h-5">
            {" "}
            {/* Changed fill from black to cyan-500 */}
      ...
      <p className="text-xs text-center my-4 md:text-lg ">لين بوتيك</p>
